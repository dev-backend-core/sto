    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <form action="#" method="POST" class="bg-white rounded-xl shadow-md border border-gray-200/80 overflow-hidden">
            ...
            style="display: flex;
                ...
                <div>
                    <h1 
                    style="font-weight: 600;font-size: larger;">Создание технологической карты</h1>
                    <p style="font-weight: 200;font-size: medium;">Укажите параметры новой услуги и выберите необходимые расходные материалы со склада.</p>
                </div>
            ...
            <div class="p-6 border-b border-gray-100 bg-white">
                <h3 class="text-sm font-bold text-indigo-600 uppercase tracking-wider" style="margin-bottom: 0.5rem;">Основные настройки услуги</h3>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Название услуги</label>
                        <input type="text" name="service_name" required value="Например: Замена тормозных колодок" class="w-full px-3 py-2 text-sm text-gray-900 bg-white rounded-xl border border-gray-300 focus:ring-1 focus:ring-indigo-500 transition-all font-semibold">
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Стоимость (₽)</label>
                        <div class="relative">
                            <input type="number" name="price" value="0" required class="w-full pl-3 pr-8 py-2 text-sm text-gray-900 bg-white rounded-xl border border-gray-300 focus:ring-1 focus:ring-indigo-500 transition-all font-bold">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="duration" value="0" required class="w-full pl-3 pr-12 py-2 text-sm text-gray-900 bg-white rounded-xl border border-gray-300 focus:ring-1 focus:ring-indigo-500 transition-all font-bold">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white">
                <h3 class="text-sm font-bold text-indigo-600 uppercase tracking-wider" style="margin-bottom: 0.3rem;">Необходимые запчасти и расходники</h3>
                <p style="font-weight: 200;">Добавленные товары появятся в таблице. Укажите их количество, необходимое для выполнения услуги.</p>
